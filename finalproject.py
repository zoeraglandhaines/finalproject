...
# [ST1-ST3] Widgets
selected_page = st.sidebar.radio("Navigation", ["Restaurant Distribution", "Category Trends"])
selected_city = st.sidebar.selectbox("Select City", cities)
selected_state = st.sidebar.selectbox("Select State", states)

filtered_data = filter_restaurants(data, selected_city, selected_state)

if selected_page == "Restaurant Distribution":
    ...
    st.pyplot(fig)
elif selected_page == "Category Trends":
    st.header("Menu Category Trends")
    # [DA6] Pivot table analysis
    category_pivot = pd.pivot_table(
        filtered_data,
        values='name',
        index='province',
        columns='category_count',
        aggfunc='count',
        fill_value=0
    )
    ...
    ax2.set_title("Number of Menu Categories by State")
    st.pyplot(fig2)
# [PY3] Error handling
try:
